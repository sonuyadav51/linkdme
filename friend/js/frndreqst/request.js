    ...
    $(document).ready(function() {
        $('.search').keyup(function(e) {
            ...
            if (Svalue != '') {
                $.ajax({
                    url: "databases/frndreqst/search.php",
                    method: "post",
                    data: {
                        Svalue: Svalue
                    },
    ...
    function reqnotification() {
        ...
        //var post_id = $('.like-btn').data('id');
        $.ajax({
            url: "databases/frndreqst/countreq.php",
            method: "post",
            data: "",
            success: function(data) {
                // alert(data);
        ...
        $('.reqnoti').click(function() {
            $.ajax({
                url: "databases/frndreqst/updatereq.php",
                method: "post",
                data: "",
                success: function(data) {
    ...
    $('.s').click(function(e) {
        ...
        $('.r,.f').removeClass("active");
        //$('.s a').css("color","white");
    });
    $('.r').click(function(e) {
        // e.preventDefault();
        $(this).addClass("active");
        $('.s,.f').removeClass("active");
        // $('.r a').css("color","white");
    });
    $('.f').click(function(e) {
        //e.preventDefault();
