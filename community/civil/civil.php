...
<div class="container-fluid">
    ...
    <div class="row  head text-center">
      <h5 class="pl-3 pt-3 "><a href="../../home.php" class="text-danger"><i class="fas fa-arrow-left"></i></a></h5>
       <h1 class="text-center mx-auto my-5">civil engineering</h1>
    </div>
...
<div class="container-fluid serc">
 <div class="row  search serc">
              <div class="col-12 mx-auto col-md-12 mx-md-auto serc">
                 <form class='serc'>
                    
                         <div class="serc">
                             <span class="  search-box search-icon" id="search-icon" style="">
                                 <i class="fas fa-search"></i>
                             </span>
                              <input type="text" class="pl-md-5 search-item" id="search-item"  placeholder="search in civil engineering...">
                         </div>
